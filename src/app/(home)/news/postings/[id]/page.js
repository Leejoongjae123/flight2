            ...
            <div className="flex items-center justify-between mt-8">
              {prevId && (
                <Link
                  ...
                  className="inline-flex border border-gray-300 items-center gap-2 py-3 px-5 text-lg font-medium transition-transform transform hover:scale-110 rounded-md"
                  prefetch={false}
                >
