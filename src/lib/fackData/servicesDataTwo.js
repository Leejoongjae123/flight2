...
import Scan from "../../../public/icons/scan"
...
export const servicesDataTwo = [
    {
        id: 1,
        icon_1: <Image src="/images/companylogo/koreanair.jpg" height={100} width={100}/>,
        service_name: "대한항공 | 신입조종사(민경력 모집)",
        description: "고정익 비행시간 총 1,000시간 이상인 자 (후방석 비행시간 제외)<br/>국내 자격증명 (CPL, MEL, IR, 항공업 4등급 이상) 소지자"
    },
    {
        id: 2,
        icon_1: <Image src="/images/companylogo/tway.png" height={100} width={100}/>,
    ...
    {
        id: 4,
        icon_1: <Image src="/images/companylogo/airpremia.png" height={100} width={100}/>,
    ...
    {
        id: 5,
        icon_1: <Image src="/images/companylogo/aerok.png" height={100} width={100}/>,
    ...
    {
        id: 6,
        icon_1: <Image src="/images/companylogo/kai.png" height={100} width={100}/>,
        service_name: "KAI(한국항공우주산업) | 이라크 CLS사업 항공기 교관조종사",
        description: "수헬기/휠헬기/모의비행 훈련 교관업무, 비행계획수립, 지상비행훈련업무 등<br/>고정익 훈련기 총 비행시간 보유자, 군 비행유무원 신체검사 기준 적합자"
    },
    {
        id: 7,
        icon_1: <Discount height={100} width={100} />,
