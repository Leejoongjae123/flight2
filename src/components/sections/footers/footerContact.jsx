      ...
      <div className='flex md:flex-row flex-col justify-end gap-4'>
        <div className='flex items-end gap-8'>
          ...
          <div className={cn(`${color}`)}>
            ...
            <p> <span className='font-semibold'>카카오톡:</span> <Link target='_blank' href={"https://pf.kakao.com/_xkXxjx"} className='relative hover-underline after:h-[1px] after:bg-muted'>@UND항공대학글로벌패스웨이</Link> </p>
