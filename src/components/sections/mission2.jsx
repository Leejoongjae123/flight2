...
const Mission = () => {
  return (
    <section className='py-9'>
      <div className='max-w-[1350px] mx-auto px-[15px]'>
        <div className='flex flex-col lg:flex-col justify-center items-center gap-7.5'>
          ...
          <div className='w-full'>
            <SlideLeft>
              ...
              <p className='font-semibold text-gray-600 text-center mt-5'>
                ...
                UND 글로벌 패스웨이는 UND의 교육용 헬기인 R44 기종으로 회전익 항공기 자가용 <span className='text-red'>조종사 면장(PPL)을 취득</span>하여 배점에 큰 우위를 갖춘 인재를 양성하고 있습니다.
          ...
          <div className='pt-3 lg:pt-0 w-full'>
            <SlideUp>
              <div className="sm:rounded-lg overflow-x-auto shadow-md">
                <table className="w-[600px] md:w-full text-medium text-left rtl:text-right text-gray-500 ">
                  ...
                  <tbody className='text-center text-muted-foreground'>
                    <tr className="bg-white dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                      ...
                      <td className="px-6 py-4">
                        <ul>
                          <li><span className='text-red font-bold text-lg'>조종사 면장</span></li>
                          <li>항공기관기술사</li>
                          <li>항공기체기술사</li>
                          <li>*경량/초경량 면장 제외</li>
                        </ul>
      ...
      <SlideUp>
        <div className='grid grid-cols-2 gap-5 max-w-[1350px] mx-auto px-[15px]'>
          <div className='relative w-full h-[30vh]'>
            <Image src="/images/military/military1.png" fill className='object-cover rounded-2xl' />
          </div>
          <div className='relative w-full h-[30vh]'>
            <Image src="/images/military/military2.png" fill className='object-cover rounded-2xl' />
          </div>
        </div>
      </SlideUp>
    </section>
