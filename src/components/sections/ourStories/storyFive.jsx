    ...
    return (
        <section className='lg:py-15 py-9 overflow-x-hidden'>
            <div className='container'>
                ...
                <div className='relative pt-7 pb-6 xl:pb-0 px-2.5 after:absolute after:z-[-1] after:left-0 after:top-0 after:bg-[#2e4dfe0d] after:w-full h-full after:rounded-[50px]'>
                    <div className='flex lg:flex-row flex-col justify-center 2xl:gap-[144px] xl:gap-20 lg:gap-10 gap-5'>
                        <div className=' max-w-[534px] relative '>
                            <div className='relative rounded-lg overflow-hidden'>
                                ...
                                {/* <Image src={"/images/resource/president.jpg"} width={510} height={670} sizes='(max-width:1024px) 100vw, 50vw' alt='stroy background' className='absolute bottom-0' /> */}
                            </div>
