    ...
    <div className='h-full'>
      <SlideUp>
        <Title size={"5xl"} className={"xl:leading-[140%] lg:max-w-[645px]"}>
          UND 항공대학교 글로벌 패스웨이 대표원장 인사말
        </Title>

        <div className='lg:max-w-[645px]'>
          <p className='font-bold text-muted-foreground mt-6'>
            안녕하세요, UND 항공대학교 글로벌 패스웨이의 대표원장 김원섭입니다. 저희 UND 항공대학교 글로벌 패스웨이에 오신 것을 진심으로 환영합니다. UND는 뛰어난 교육과 다양한 프로그램으로 세계적으로 인정받는 대학교입니다. 저희는 UND와의 국내 최초 MOU를 체결하여, 수준 높은 교육을 통해 미래의 조종사 인재들을 모집하고 있습니다.

          </p>

          <p className='mt-7.5 font-bold'>
            UND 항공대학교 글로벌 패스웨이는 학생들이 조종사의 꿈을 이루기 위해 최선을 다할 수 있는 환경을 제공합니다. 저희 프로그램은 이론과 실습을 균형 있게 구성하여, 학생들이 국제적으로 경쟁력 있는 조종사로 성장할 수 있도록 지원합니다. 또한, 전문 교수진과의 밀접한 협력으로 학생들이 필요한 모든 자원을 활용할 수 있도록 돕고 있습니다.
