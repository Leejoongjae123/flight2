      ...
      <div className='max-w-[1350px] mx-auto px-[15px]'>
        ...
        <div className='flex justify-center items-center flex-col pt-12.5 relative z-[1] after:absolute after:left-0 after:bottom-0 after:w-full after:h-[calc(100%-276px)] after:bg-accent after:rounded-[30px] after:z-[-1]'>
          ...
          <div className='pt-[46px] grid  grid-cols-1 md:grid-cols-2  max-w-[1160px] mx-auto pb-12.5 px-3 lg:px-0 gap-y-5 items-center '>
            <SlideRight id={3}>
              ...
              <div className='flex md:flex-row flex-col  items-center lg:gap-7 gap-4 pt-7 lg:pt-0 gap-y-5'>
                ...
                <div className='max-w-[450px] gap-y-10'>
                  <Title size={"2xl"}>
                    <Link href={"/service-details"} className='relative hover-underline after:bg-muted after:h-[1px] after:bottom-[1px]'><p className='text-center md:text-left'>UND 항공대학교 글로벌 패스웨이<br/>육군 항공 준사관 커리큘럼</p></Link>
                  </Title>
                  <p className='text-center md:text-left'>현재 인적성 기출 문제집을 기준으로 맞춤형 인적성 강의 제공</p>
                </div>
              </div>
            </SlideRight>
            <SlideRight id={5}>
            ...
            <SlideLeft id={5}>
              <Card className="cols-span-1" icon={<TbLicense />} title={"FAA 헬기 자가용 면장 취득"} desc={"선진화된 FAA 인가 헬기 항공기 교육기관인 UND 헬기 조종사 과정에 입과하여 타 교육기관보다 합리적인 가격으로 헬기 자가용 조종사 면장을 취득"} />
            </SlideLeft>
          </div>
        </div>
      </div>
