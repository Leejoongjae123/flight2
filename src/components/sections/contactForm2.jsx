  ...
  return (
    <section className='container lg:mt-15 mt-9'>
      ...
      <div className={` bg-primary lg:rounded-[30px] rounded-2xl px-3 relative z-[1]`}>
        ...
        <div className={`max-w-[1320px] mx-auto rounded-[30px] flex flex-col justify-center items-center p-5 md:p-20`}>
              ...
              <SlideUp>
                <div className='flex flex-col items-center justify-center'>
                  ...
                  <div className='flex justify-center items-center my-5'>
                    <Button onClick={handleClick} variant={"secondary"} className="bg-white border text-blue-800 transition-transform duration-300 hover:scale-105">방문상담 신청</Button>
                  </div>
                </div>
