    ...
    <section className='lg:py-15 py-9'>
      ...
      <div className='max-w-[1350px] mx-auto px-[15px] flex flex-col justify-center items-center'>
        ...
        <section className="bg-white dark:bg-gray-900 w-full">
          <div className="max-w-[1350px] px-4 py-10 mx-auto lg:px-6">
            ...
            <div
              className="max-w-[1180px] p-15 mx-auto mt-8 space-y-5 border border-gray-100 rounded-lg bg-[rgba(46,77,254,0.05)] ">
